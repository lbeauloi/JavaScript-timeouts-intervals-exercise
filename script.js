...
//---MON APPROCHE---
// 1. calculer le temps écouler sur la page et le log dans la console.
// let = startTime = new Date();
// function tempsEcoule() {
//   let currentTime = new Date();
//   elapsedTime = Math.floor((currentTime - startTime) / 1000); //math floor pour arrondir car on est en milli seconde puis on divise par 1000 pour revenir en seconde
//   console.log(elapsedTime);
// }
// setInterval(tempsEcoule, 1000);

// Si +60 alors affiché "une minute est passée"
